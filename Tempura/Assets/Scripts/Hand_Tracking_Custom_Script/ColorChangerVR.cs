...
public class ColorChangerVR : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //_renderer.material.SetColor("_Tint", _startColor);
        _totalTime = 0;
...
*/
    ...
    public void KoromoColorChanger(){
        _renderer.material.SetFloat("_RimPower", 0.61f);
        _renderer.material.SetFloat("_RampPower", 2.0f);
        _renderer.material.SetColor("_Tint", new Color(255 / 255f, 255 / 255f, 243 / 255f, 1.0f));
        _renderer.material.SetColor("_TransluencyColor", new Color(255 / 255f, 255 / 255f, 255 / 255f, 1.0f));
        _renderer.material.SetColor("_RimColor", new Color(255 / 255f, 255 / 255f, 255 / 255f, 1.0f));
    }

    public void colorchanger(float totalTime,float _targetTime)
    {
        _renderer.material.SetFloat("_RimPower", 1.7f);
        _renderer.material.SetColor("_RimColor", new Color(91 / 255f, 91 / 255f, 91 / 255f, 1.0f));
        //_renderer.material.SetFloat("_RimPower", 1.7f);
        //_renderer.material.SetFloat("_RampPower", 0.521f);
        ...
        if (_totalTime >= 0.5 * _targetTime && _totalTime<1.1*_targetTime)
        {
            ...
            //_renderer.material.color =
                //Color.Lerp(_startColor, _targetColor, lerpTime);//色を線形的に変える
            _renderer.material.SetColor("_Tint", Color.Lerp(_startColor, _targetColor, lerpTime));
            _renderer.material.SetFloat("_RampPower", 0.4f);
        }
        //1.1*targetTimeから1.5*targetTimeまで，_targetcolorからblackまで線形的に色が変わる．
        else if (_totalTime >= 1.1 * _targetTime && _totalTime < 1.5 * _targetTime)
        {
            ...
            //_renderer.material.color =
               // Color.Lerp(_targetColor, black, lerpTime);
            _renderer.material.SetColor("_Tint", Color.Lerp(_targetColor, black, lerpTime));
            _renderer.material.SetFloat("_RampPower", 0.0f);
        }
    }
